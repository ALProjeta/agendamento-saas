            ...
            return (
              ...
              >
                <div className="relative">
                  {item.icon}
                  {isAgenda && todayCount > 0 && (
                    <span
                      className="absolute -top-1.5 -right-1.5 min-w-[16px] h-4 rounded-full text-[9px] font-bold flex items-center justify-center px-0.5 text-black"
